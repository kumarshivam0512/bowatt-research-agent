    ...
    <main className="app-shell">
      ...
      <section className="panel" aria-labelledby="request-heading">
        ...
        <form className="form-stack" onSubmit={handleResearchSubmit}>
          ...
          />
          <div className="button-row">
            <select aria-label="Reasoning" value={reasoningEffort} onChange={(event) => setReasoningEffort(event.currentTarget.value)} disabled={isResearching}>
              <option value="none">Minimal</option><option value="low">Low</option><option value="medium">Medium</option><option value="high">High</option>
            </select>
